          ...
          <Timeline active={0} bulletSize={24} lineWidth={4}>
            ...
            >
              <Text color="dimmed" size="sm">
                ...
                for choosing <span className="text-green-500">Shoppers</span>
              </Text>
              <Text size="xs" mt={4}>
                2 hours ago
              </Text>
            ...
            >
              <Text color="dimmed" size="sm">
                ...
                shipment. We'll keep you updated on its progress
              </Text>
              <Text size="xs" mt={4}>
                52 minutes ago
              </Text>
            ...
            >
              <Text color="dimmed" size="sm">
                Your order has been shipped and is on its way to you! You'll
                receive an update with a tracking number soon
              </Text>
              <Text size="xs" mt={4}>
                34 minutes ago
              </Text>
            ...
            >
              <Text color="dimmed" size="sm">
                Your order is now out for delivery and should arrive at your
                door today. We can't wait for you to enjoy your purchase!"
              </Text>
              <Text size="xs" mt={4}>
                12 minutes ago
              </Text>
            ...
            <Timeline.Item title="Delivered" bullet={<IconCheck size={18} />}>
              <Text color="dimmed" size="sm">
                ...
                purchase. Thank you for choosing{' '}
